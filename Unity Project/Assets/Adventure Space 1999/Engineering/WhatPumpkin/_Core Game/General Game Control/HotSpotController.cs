...
namespace WhatPumpkin.Sgrid.Triggers {
	...
	public class HotSpotController : MonoBehaviour, IHotSpotController {
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="WhatPumpkin.Entities.Triggers.HotSpotController"/> are hot
		/// spots active.
		/// </summary>
		...
		public virtual bool AreHotSpotsActive { get 
			...
			{
					return !GameController.MessageManager.IsShowingNarratorMessage &&
		...
		public virtual bool AreHotSpotConditionsMet(IHotSpot hotspot) {return HasRequiredItems((HotSpot)hotspot) && MeetsCameraConditions((HotSpot)hotspot);}
