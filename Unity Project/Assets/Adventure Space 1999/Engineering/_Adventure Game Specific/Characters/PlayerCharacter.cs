...
namespace WhatPumpkin.Sgrid.Characters {
	...
	public class PlayerCharacter : Character, ICharacterSaveData_Act1, ISwitchable, IMoveable, ITriggersCamSwitch, IKeyed, IPartyMember {
		...
		public override float CurrentSpeed { 
			get { 
				...
				if(aiPath != null) {
					...
					// TODO: Get the actual speed not this hacky quick script that means little but have gotten away with for too long
		...
		public override bool IsActive { get { return this == _active; } }
		...
		public IPlayerInventory Inventory {
				get {
					...
					IPlayerInventory inventory = this.GetComponent<IPlayerInventory>();
					// Return
					return inventory;
				}
		}
		...
		protected override void Start() {
			...
			Environment.Room.RoomActivated += HandleRoomActivated;
...
//				Debug.Log ("Subscribe to scene load end");
		...
		void AllowMovement() {
			...
			this.GetComponent<IAIPath> ().Speed = _speed;
		}
		...
		public override void StopMoving() {
			...
			this.GetComponent<IAIPath> ().Speed = 0;
